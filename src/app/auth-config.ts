...
export const b2cPolicies = {
  names: {
    signUpSignIn: 'B2C_1_SingUpSingIn', //replace these names properly the way you created in azure portal
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://learnsmartcoding.b2clogin.com/learnsmartcoding.onmicrosoft.com/B2C_1_SingUpSingIn',
    },
    editProfile: {
      authority:
        'https://learnsmartcoding.b2clogin.com/learnsmartcoding.onmicrosoft.com/B2C_1_ProfileEdit',
    },
    passwordReset: {
      authority:
        'https://learnsmartcoding.b2clogin.com/learnsmartcoding.onmicrosoft.com/B2C_1_PasswordReset',
    }
  },
  authorityDomain: 'learnsmartcoding.b2clogin.com',//replace your domain name here
};
